...
public class JavaCodeScanner extends RuleBasedScanner{
	...
	public JavaCodeScanner(JavaColorProvider provider) {
		...
		IToken keyword= new Token(new TextAttribute(provider.getColor(JavaColorProvider.KEYWORD), null, Font.BOLD));
		IToken type= new Token(new TextAttribute(provider.getColor(JavaColorProvider.TYPE), null, Font.BOLD));
